...
(function() {
    ...
    // log in to Verto server with specified credentials and configurations
    function bootstrap(status) {
        // Create a new verto instance:
        // This step performs a user login to FreeSWITCH via secure websocket.
        // The user must be properly configured in the FreeSWITCH <Softswitch> user directory.
    ...
    // callbacks - event handlers to receive and process events in Verto
    vertoCallbacks = {
      onWSLogin: onWSLogin,
      onWSClose: onWSClose
    };
